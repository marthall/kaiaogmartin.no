 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function cr(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function Ch(){var e;const t=(e=vs())===null||e===void 0?void 0:e.forceEnvironment;if(t==="node")return!0;if(t==="browser")return!1;try{return Object.prototype.toString.call(global.process)==="[object process]"}catch{return!1}}function Vh(){return!Ch()&&navigator.userAgent.includes("Safari")&&!navigator.userAgent.includes("Chrome")}function pu(){try{return typeof indexedDB=="object"}catch{return!1}}function kh(){return new Promise((e,t)=>{try{let n=!0;const r="validate-browser-context-for-indexeddb-analytics-module",i=self.indexedDB.open(r);i.onsuccess=()=>{i.result.close(),n||self.indexedDB.deleteDatabase(r),e(!0)},i.onupgradeneeded=()=>{n=!1},i.onerror=()=>{var s;t(((s=i.error)===null||s===void 0?void 0:s.message)||"")}}catch(n){t(n)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bh="FirebaseError";class $e extends Error{constructor(t,n,r){super(n),this.code=t,this.customData=r,this.name=bh,Object.setPrototypeOf(this,$e.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,mu.prototype.create)}}class mu{constructor(t,n,r){this.service=t,this.serviceName=n,this.errors=r}create(t,...n){const r=n[0]||{},i=`${this.service}/${t}`,s=this.errors[t],o=s?Dh(s,r):"Error",a=`${this.serviceName}: ${o} (${i}).`;return new $e(i,a,r)}}function Dh(e,t){return e.replace(Nh,(n,r)=>{const i=t[r];return i!=null?String(i):`<${r}?>`})}const Nh=/\{\$([^}]+)}/g;function $i(e,t){if(e===t)return!0;const n=Object.keys(e),r=Object.keys(t);for(const i of n){if(!r.includes(i))return!1;const s=e[i],o=t[i];if(Fo(s)&&Fo(o)){if(!$i(s,o))return!1}else if(s!==o)return!1}for(const i of r)if(!n.includes(i))return!1;return!0}function Fo(e){return e!==null&&typeof e=="object"}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xh{constructor(t,n){this.name=t,this.container=n,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}get(t){const n=this.normalizeInstanceIdentifier(t);if(!this.instancesDeferred.has(n)){const r=new Sh;if(this.instancesDeferred.set(n,r),this.isInitialized(n)||this.shouldAutoInitialize())try{const i=this.getOrInitializeService({instanceIdentifier:n});i&&r.resolve(i)}catch{}}return this.instancesDeferred.get(n).promise}getImmediate(t){var n;const r=this.normalizeInstanceIdentifier(t==null?void 0:t.identifier),i=(n=t==null?void 0:t.optional)!==null&&n!==void 0?n:!1;if(this.isInitialized(r)||this.shouldAutoInitialize())try{return this.getOrInitializeService({instanceIdentifier:r})}catch(s){if(i)return null;throw s}else{if(i)return null;throw Error(`Service ${this.name} is not available`)}}getComponent(){return this.component}setComponent(t){if(t.name!==this.name)throw Error(`Mismatching Component ${t.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=t,!!this.shouldAutoInitialize()){if(Mh(t))try{this.getOrInitializeService({instanceIdentifier:ee})}catch{}for(const[n,r]of this.instancesDeferred.entries()){const i=this.normalizeInstanceIdentifier(n);try{const s=this.getOrInitializeService({instanceIdentifier:i});r.resolve(s)}catch{}}}}clearInstance(t=ee){this.instancesDeferred.delete(t),this.instancesOptions.delete(t),this.instances.delete(t)}async delete(){const t=Array.from(this.instances.values());await Promise.all([...t.filter(n=>"INTERNAL"in n).map(n=>n.INTERNAL.delete()),...t.filter(n=>"_delete"in n).map(n=>n._delete())])}isComponentSet(){return this.component!=null}isInitialized(t=ee){return this.instances.has(t)}getOptions(t=ee){return this.instancesOptions.get(t)||{}}initialize(t={}){const{options:n={}}=t,r=this.normalizeInstanceIdentifier(t.instanceIdentifier);if(this.isInitialized(r))throw Error(`${this.name}(${r}) has already been initialized`);if(!this.isComponentSet())throw Error(`Component ${this.name} has not been registered yet`);const i=this.getOrInitializeService({instanceIdentifier:r,options:n});for(const[s,o]of this.instancesDeferred.entries()){const a=this.normalizeInstanceIdentifier(s);r===a&&o.resolve(i)}return i}onInit(t,n){var r;const i=this.normalizeInstanceIdentifier(n),s=(r=this.onInitCallbacks.get(i))!==null&&r!==void 0?r:new Set;s.add(t),this.onInitCallbacks.set(i,s);const o=this.instances.get(i);return o&&t(o,i),()=>{s.delete(t)}}invokeOnInitCallbacks(t,n){const r=this.onInitCallbacks.get(n);if(r)for(const i of r)try{i(t,n)}catch{}}getOrInitializeService({instanceIdentifier:t,options:n={}}){let r=this.instances.get(t);if(!r&&this.component&&(r=this.component.instanceFactory(this.container,{instanceIdentifier:Oh(t),options:n}),this.instances.set(t,r),this.instancesOptions.set(t,n),this.invokeOnInitCallbacks(r,t),this.component.onInstanceCreated))try{this.component.onInstanceCreated(this.container,t,r)}catch{}return r||null}normalizeInstanceIdentifier(t=ee){return this.component?this.component.multipleInstances?t:ee:t}shouldAutoInitialize(){return!!this.component&&this.component.instantiationMode!=="EXPLICIT"}}function Oh(e){return e===ee?void 0:e}function Mh(e){return e.instantiationMode==="EAGER"}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const le=new gu("@firebase/app"),ed="@firebase/app-compat",nd="@firebase/analytics-compat",rd="@firebase/analytics",id="@firebase/app-check-compat",sd="@firebase/app-check",od="@firebase/auth",ad="@firebase/auth-compat",ud="@firebase/database",cd="@firebase/database-compat",ld="@firebase/functions",hd="@firebase/functions-compat",dd="@firebase/installations",fd="@firebase/installations-compat",pd="@firebase/messaging",md="@firebase/messaging-compat",gd="@firebase/performance",_d="@firebase/performance-compat",yd="@firebase/remote-config",vd="@firebase/remote-config-compat",Ed="@firebase/storage",Td="@firebase/storage-compat",Id="@firebase/firestore",wd="@firebase/firestore-compat",Ad="firebase",Rd="10.7.2";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lr=new Map,Hi=new Map;function Pd(e,t){try{e.container.addComponent(t)}catch(n){le.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function hr(e){const t=e.name;if(Hi.has(t))return le.debug(`There were multiple attempts to register component ${t}.`),!1;Hi.set(t,e);for(const n of lr.values())Pd(n,e);return!0}function Cd(e,t){const n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const he=new gu("@firebase/firestore");function Xe(){return he.logLevel}function y(e,...t){if(he.logLevel<=O.DEBUG){const n=t.map(qs);he.debug(`Firestore (${qe}): ${e}`,...n)}}function bt(e,...t){if(he.logLevel<=O.ERROR){const n=t.map(qs);he.error(`Firestore (${qe}): ${e}`,...n)}}function Ne(e,...t){if(he.logLevel<=O.WARN){const n=t.map(qs);he.warn(`Firestore (${qe}): ${e}`,...n)}}function qs(e){if(typeof e=="string")return e;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function S(e="Unexpected state"){const t=`FIRESTORE (${qe}) INTERNAL ASSERTION FAILED: `+e;throw bt(t),new Error(t)}function $(e,t){e||S()}function b(e,t){return e}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Fn(e){if(e.code!==g.FAILED_PRECONDITION||e.message!==cp)throw e;y("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ua(e){let t=0;for(const n in e)Object.prototype.hasOwnProperty.call(e,n)&&t++;return t}function me(e,t){for(const n in e)Object.prototype.hasOwnProperty.call(e,n)&&t(n,e[n])}function Pc(e){for(const t in e)if(Object.prototype.hasOwnProperty.call(e,t))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ht{constructor(t){this.binaryString=t}static fromBase64String(t){const n=function(i){try{return atob(i)}catch(s){throw typeof DOMException<"u"&&s instanceof DOMException?new Cc("Invalid base64 string: "+s):s}}(t);return new ht(n)}static fromUint8Array(t){const n=function(i){let s="";for(let o=0;o<i.length;++o)s+=String.fromCharCode(i[o]);return s}(t);return new ht(n)}[Symbol.iterator](){let t=0;return{next:()=>t<this.binaryString.length?{value:this.binaryString.charCodeAt(t++),done:!1}:{value:void 0,done:!0}}}toBase64(){return function(n){return btoa(n)}(this.binaryString)}toUint8Array(){return function(n){const r=new Uint8Array(n.length);for(let i=0;i<n.length;i++)r[i]=n.charCodeAt(i);return r}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(t){return M(this.binaryString,t.binaryString)}isEqual(t){return this.binaryString===t.binaryString}}ht.EMPTY_BYTE_STRING=new ht("");const pp=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function Qt(e){if($(!!e),typeof e=="string"){let t=0;const n=pp.exec(e);if($(!!n),n[1]){let i=n[1];i=(i+"000000000").substr(0,9),t=Number(i)}const r=new Date(e);return{seconds:Math.floor(r.getTime()/1e3),nanos:t}}return{seconds:G(e.seconds),nanos:G(e.nanos)}}function G(e){return typeof e=="number"?e:typeof e=="string"?Number(e):0}function de(e){return typeof e=="string"?ht.fromBase64String(e):ht.fromUint8Array(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ut{constructor(t,n,r,i,s,o,a){this.key=t,this.documentType=n,this.version=r,this.readTime=i,this.createTime=s,this.data=o,this.documentState=a}static newInvalidDocument(t){return new ut(t,0,k.min(),k.min(),k.min(),vt.empty(),0)}static newFoundDocument(t,n,r,i){return new ut(t,1,n,k.min(),r,i,0)}static newNoDocument(t,n){return new ut(t,2,n,k.min(),k.min(),vt.empty(),0)}static newUnknownDocument(t,n){return new ut(t,3,n,k.min(),k.min(),vt.empty(),2)}convertToFoundDocument(t,n){return!this.createTime.isEqual(k.min())||this.documentType!==2&&this.documentType!==0||(this.createTime=t),this.version=t,this.documentType=1,this.data=n,this.documentState=0,this}convertToNoDocument(t){return this.version=t,this.documentType=2,this.data=vt.empty(),this.documentState=0,this}convertToUnknownDocument(t){return this.version=t,this.documentType=3,this.data=vt.empty(),this.documentState=2,this}setHasCommittedMutations(){return this.documentState=2,this}setHasLocalMutations(){return this.documentState=1,this.version=k.min(),this}setReadTime(t){return this.readTime=t,this}get hasLocalMutations(){return this.documentState===1}get hasCommittedMutations(){return this.documentState===2}get hasPendingWrites(){return this.hasLocalMutations||this.hasCommittedMutations}isValidDocument(){return this.documentType!==0}isFoundDocument(){return this.documentType===1}isNoDocument(){return this.documentType===2}isUnknownDocument(){return this.documentType===3}isEqual(t){return t instanceof ut&&this.key.isEqual(t.key)&&this.version.isEqual(t.version)&&this.documentType===t.documentType&&this.documentState===t.documentState&&this.data.isEqual(t.data)}mutableCopy(){return new ut(this.key,this.documentType,this.version,this.readTime,this.createTime,this.data.clone(),this.documentState)}toString(){return`Document(${this.key}, ${this.version}, ${JSON.stringify(this.data.value)}, {createTime: ${this.createTime}}), {documentType: ${this.documentType}}), {documentState: ${this.documentState}})`}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xr{constructor(t,n=null,r=[],i=[],s=null,o="F",a=null,u=null){this.path=t,this.collectionGroup=n,this.explicitOrderBy=r,this.filters=i,this.limit=s,this.limitType=o,this.startAt=a,this.endAt=u,this.le=null,this.he=null,this.Pe=null,this.startAt,this.endAt}}function Pp(e,t,n,r,i,s,o,a){return new Xr(e,t,n,r,i,s,o,a)}function Js(e){return new Xr(e)}function ga(e){return e.filters.length===0&&e.limit===null&&e.startAt==null&&e.endAt==null&&(e.explicitOrderBy.length===0||e.explicitOrderBy.length===1&&e.explicitOrderBy[0].field.isKeyField())}function Cp(e){return e.collectionGroup!==null}function un(e){const t=b(e);if(t.le===null){t.le=[];const n=new Set;for(const s of t.explicitOrderBy)t.le.push(s),n.add(s.field.canonicalString());const r=t.explicitOrderBy.length>0?t.explicitOrderBy[t.explicitOrderBy.length-1].dir:"asc";(function(o){let a=new it(nt.comparator);return o.filters.forEach(u=>{u.getFlattenedFilters().forEach(c=>{c.isInequality()&&(a=a.add(c.field))})}),a})(t).forEach(s=>{n.has(s.canonicalString())||s.isKeyField()||t.le.push(new Er(s,r))}),n.has(nt.keyField().canonicalString())||t.le.push(new Er(nt.keyField(),r))}return t.le}function Vt(e){const t=b(e);return t.he||(t.he=Vp(t,un(e))),t.he}function Vp(e,t){if(e.limitType==="F")return ma(e.path,e.collectionGroup,t,e.filters,e.limit,e.startAt,e.endAt);{t=t.map(i=>{const s=i.dir==="desc"?"asc":"desc";return new Er(i.field,s)});const n=e.endAt?new vr(e.endAt.position,e.endAt.inclusive):null,r=e.startAt?new vr(e.startAt.position,e.startAt.inclusive):null;return ma(e.path,e.collectionGroup,t,e.filters,e.limit,n,r)}}function us(e,t,n){return new Xr(e.path,e.collectionGroup,e.explicitOrderBy.slice(),e.filters.slice(),t,n,e.startAt,e.endAt)}function Yr(e,t){return Ys(Vt(e),Vt(t))&&e.limitType===t.limitType}function Mc(e){return`${Xs(Vt(e))}|lt:${e.limitType}`}function ve(e){return`Query(target=${function(n){let r=n.path.canonicalString();return n.collectionGroup!==null&&(r+=" collectionGroup="+n.collectionGroup),n.filters.length>0&&(r+=`, filters: [${n.filters.map(i=>xc(i)).join(", ")}]`),Qr(n.limit)||(r+=", limit: "+n.limit),n.orderBy.length>0&&(r+=`, orderBy: [${n.orderBy.map(i=>function(o){return`${o.field.canonicalString()} (${o.dir})`}(i)).join(", ")}]`),n.startAt&&(r+=", startAt: ",r+=n.startAt.inclusive?"b:":"a:",r+=n.startAt.position.map(i=>Me(i)).join(",")),n.endAt&&(r+=", endAt: ",r+=n.endAt.inclusive?"a:":"b:",r+=n.endAt.position.map(i=>Me(i)).join(",")),`Target(${r})`}(Vt(e))}; limitType=${e.limitType})`}function Jr(e,t){return t.isFoundDocument()&&function(r,i){const s=i.key.path;return r.collectionGroup!==null?i.key.hasCollectionId(r.collectionGroup)&&r.path.isPrefixOf(s):w.isDocumentKey(r.path)?r.path.isEqual(s):r.path.isImmediateParentOf(s)}(e,t)&&function(r,i){for(const s of un(r))if(!s.field.isKeyField()&&i.data.field(s.field)===null)return!1;return!0}(e,t)&&function(r,i){for(const s of r.filters)if(!s.matches(i))return!1;return!0}(e,t)&&function(r,i){return!(r.startAt&&!function(o,a,u){const c=fa(o,a,u);return o.inclusive?c<=0:c<0}(r.startAt,un(r),i)||r.endAt&&!function(o,a,u){const c=fa(o,a,u);return o.inclusive?c>=0:c>0}(r.endAt,un(r),i))}(e,t)}function kp(e){return e.collectionGroup||(e.path.length%2==1?e.path.lastSegment():e.path.get(e.path.length-2))}function Lc(e){return(t,n)=>{let r=!1;for(const i of un(e)){const s=bp(i,t,n);if(s!==0)return s;r=r||i.field.isKeyField()}return 0}}function bp(e,t,n){const r=e.field.isKeyField()?w.comparator(t.key,n.key):function(s,o,a){const u=o.data.field(s),c=a.data.field(s);return u!==null&&c!==null?Oe(u,c):S()}(e.field,t,n);switch(e.dir){case"asc":return r;case"desc":return-1*r;default:return S()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dp=new q(w.comparator);function Bt(){return Dp}const Fc=new q(w.comparator);function tn(...e){let t=Fc;for(const n of e)t=t.insert(n.key,n);return t}function Uc(e){let t=Fc;return e.forEach((n,r)=>t=t.insert(n,r.overlayedDocument)),t}function ae(){return cn()}function $c(){return cn()}function cn(){return new ze(e=>e.toString(),(e,t)=>e.isEqual(t))}const Np=new q(w.comparator),xp=new it(w.comparator);function N(...e){let t=xp;for(const n of e)t=t.add(n);return t}const Op=new it(M);function Mp(){return Op}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ni{constructor(t,n,r,i,s){this.snapshotVersion=t,this.targetChanges=n,this.targetMismatches=r,this.documentUpdates=i,this.resolvedLimboDocuments=s}static createSynthesizedRemoteEventForCurrentChange(t,n,r){const i=new Map;return i.set(t,$n.createSynthesizedTargetChangeForCurrentChange(t,n,r)),new ni(k.min(),i,new q(M),Bt(),N())}}class $n{constructor(t,n,r,i,s){this.resumeToken=t,this.current=n,this.addedDocuments=r,this.modifiedDocuments=i,this.removedDocuments=s}static createSynthesizedTargetChangeForCurrentChange(t,n,r){return new $n(r,n,N(),N(),N())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bm{constructor(){this.$i=!1,this.Ui=!1,this.Wi=100,this.Gi=function(){return Vh()?8:oe.v(cr())>0?6:4}()}initialize(t,n){this.zi=t,this.indexManager=n,this.$i=!0}getDocumentsMatchingQuery(t,n,r,i){const s={result:null};return this.ji(t,n).next(o=>{s.result=o}).next(()=>{if(!s.result)return this.Hi(t,n,i,r).next(o=>{s.result=o})}).next(()=>{if(s.result)return;const o=new km;return this.Ji(t,n,o).next(a=>{if(s.result=a,this.Ui)return this.Yi(t,n,o,a.size)})}).next(()=>s.result)}Yi(t,n,r,i){return r.documentReadCount<this.Wi?(Xe()<=O.DEBUG&&y("QueryEngine","SDK will not create cache indexes for query:",ve(n),"since it only creates cache indexes for collection contains","more than or equal to",this.Wi,"documents"),p.resolve()):(Xe()<=O.DEBUG&&y("QueryEngine","Query:",ve(n),"scans",r.documentReadCount,"local documents and returns",i,"documents as results."),r.documentReadCount>this.Gi*i?(Xe()<=O.DEBUG&&y("QueryEngine","The SDK decides to create cache indexes for query:",ve(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(t,Vt(n))):p.resolve())}ji(t,n){if(ga(n))return p.resolve(null);let r=Vt(n);return this.indexManager.getIndexType(t,r).next(i=>i===0?null:(n.limit!==null&&i===1&&(n=us(n,null,"F"),r=Vt(n)),this.indexManager.getDocumentsMatchingTarget(t,r).next(s=>{const o=N(...s);return this.zi.getDocuments(t,o).next(a=>this.indexManager.getMinOffset(t,r).next(u=>{const c=this.Zi(n,a);return this.Xi(n,c,o,u.readTime)?this.ji(t,us(n,null,"F")):this.es(t,c,n,u)}))})))}Hi(t,n,r,i){return ga(n)||i.isEqual(k.min())?p.resolve(null):this.zi.getDocuments(t,r).next(s=>{const o=this.Zi(n,s);return this.Xi(n,o,r,i)?p.resolve(null):(Xe()<=O.DEBUG&&y("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),ve(n)),this.es(t,o,n,op(i,-1)).next(a=>a))})}Zi(t,n){let r=new it(Lc(t));return n.forEach((i,s)=>{Jr(t,s)&&(r=r.add(s))}),r}Xi(t,n,r,i){if(t.limit===null)return!1;if(r.size!==n.size)return!0;const s=t.limitType==="F"?n.last():n.first();return!!s&&(s.hasPendingWrites||s.version.compareTo(i)>0)}Ji(t,n,r){return Xe()<=O.DEBUG&&y("QueryEngine","Using full collection scan to execute query:",ve(n)),this.zi.getDocumentsMatchingQuery(t,n,Wt.min(),r)}es(t,n,r,i){return this.zi.getDocumentsMatchingQuery(t,r,i).next(s=>(n.forEach(o=>{s=s.insert(o.key,o)}),s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gm extends class{}{constructor(t,n,r,i){super(),this.authCredentials=t,this.appCheckCredentials=n,this.connection=r,this.serializer=i,this.A_=!1}R_(){if(this.A_)throw new I(g.FAILED_PRECONDITION,"The client has already been terminated.")}So(t,n,r,i){return this.R_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([s,o])=>this.connection.So(t,ls(n,r),i,s,o)).catch(s=>{throw s.name==="FirebaseError"?(s.code===g.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),s):new I(g.UNKNOWN,s.toString())})}vo(t,n,r,i,s){return this.R_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([o,a])=>this.connection.vo(t,ls(n,r),i,o,a,s)).catch(o=>{throw o.name==="FirebaseError"?(o.code===g.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),o):new I(g.UNKNOWN,o.toString())})}terminate(){this.A_=!0,this.connection.terminate()}}class Wm{constructor(t,n){this.asyncQueue=t,this.onlineStateHandler=n,this.state="Unknown",this.m_=0,this.f_=null,this.g_=!0}p_(){this.m_===0&&(this.y_("Unknown"),this.f_=this.asyncQueue.enqueueAfterDelay("online_state_timeout",1e4,()=>(this.f_=null,this.w_("Backend didn't respond within 10 seconds."),this.y_("Offline"),Promise.resolve())))}S_(t){this.state==="Online"?this.y_("Unknown"):(this.m_++,this.m_>=1&&(this.b_(),this.w_(`Connection failed 1 times. Most recent error: ${t.toString()}`),this.y_("Offline")))}set(t){this.b_(),this.m_=0,t==="Online"&&(this.g_=!1),this.y_(t)}y_(t){t!==this.state&&(this.state=t,this.onlineStateHandler(t))}w_(t){const n=`Could not reach Cloud Firestore backend. ${t}
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;this.g_?(bt(n),this.g_=!1):y("OnlineStateTracker",n)}b_(){this.f_!==null&&(this.f_.cancel(),this.f_=null)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qm{constructor(t,n,r,i,s){this.localStore=t,this.datastore=n,this.asyncQueue=r,this.remoteSyncer={},this.D_=[],this.C_=new Map,this.v_=new Set,this.F_=[],this.M_=s,this.M_.io(o=>{r.enqueueAndForget(async()=>{_e(this)&&(y("RemoteStore","Restarting streams for network reachability change."),await async function(u){const c=b(u);c.v_.add(4),await Bn(c),c.x_.set("Unknown"),c.v_.delete(4),await ii(c)}(this))})}),this.x_=new Wm(r,i)}}async function ii(e){if(_e(e))for(const t of e.F_)await t(!0)}async function Bn(e){for(const t of e.F_)await t(!1)}function ll(e,t){const n=b(e);n.C_.has(t.targetId)||(n.C_.set(t.targetId,t),ao(n)?oo(n):He(n).Jo()&&so(n,t))}function hl(e,t){const n=b(e),r=He(n);n.C_.delete(t),r.Jo()&&dl(n,t),n.C_.size===0&&(r.Jo()?r.Xo():_e(n)&&n.x_.set("Unknown"))}function so(e,t){if(e.O_.Oe(t.targetId),t.resumeToken.approximateByteSize()>0||t.snapshotVersion.compareTo(k.min())>0){const n=e.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;t=t.withExpectedCount(n)}He(e).c_(t)}function dl(e,t){e.O_.Oe(t),He(e).l_(t)}function oo(e){e.O_=new Yp({getRemoteKeysForTarget:t=>e.remoteSyncer.getRemoteKeysForTarget(t),_t:t=>e.C_.get(t)||null,nt:()=>e.datastore.serializer.databaseId}),He(e).start(),e.x_.p_()}function ao(e){return _e(e)&&!He(e).Ho()&&e.C_.size>0}function _e(e){return b(e).v_.size===0}function fl(e){e.O_=void 0}async function Xm(e){e.C_.forEach((t,n)=>{so(e,t)})}async function Ym(e,t){fl(e),ao(e)?(e.x_.S_(t),oo(e)):e.x_.set("Unknown")}async function Jm(e,t,n){if(e.x_.set("Online"),t instanceof Jc&&t.state===2&&t.cause)try{await async function(i,s){const o=s.cause;for(const a of s.targetIds)i.C_.has(a)&&(await i.remoteSyncer.rejectListen(a,o),i.C_.delete(a),i.O_.removeTarget(a))}(e,t)}catch(r){y("RemoteStore","Failed to remove targets %s: %s ",t.targetIds.join(","),r),await Ar(e,r)}else if(t instanceof sr?e.O_.$e(t):t instanceof Yc?e.O_.Je(t):e.O_.Ge(t),!n.isEqual(k.min()))try{const r=await al(e.localStore);n.compareTo(r)>=0&&await function(s,o){const a=s.O_.it(o);return a.targetChanges.forEach((u,c)=>{if(u.resumeToken.approximateByteSize()>0){const h=s.C_.get(c);h&&s.C_.set(c,h.withResumeToken(u.resumeToken,o))}}),a.targetMismatches.forEach((u,c)=>{const h=s.C_.get(u);if(!h)return;s.C_.set(u,h.withResumeToken(ht.EMPTY_BYTE_STRING,h.snapshotVersion)),dl(s,u);const l=new qt(h.target,u,c,h.sequenceNumber);so(s,l)}),s.remoteSyncer.applyRemoteEvent(a)}(e,n)}catch(r){y("RemoteStore","Failed to raise snapshot:",r),await Ar(e,r)}}async function Ar(e,t,n){if(!Un(t))throw t;e.v_.add(1),await Bn(e),e.x_.set("Offline"),n||(n=()=>al(e.localStore)),e.asyncQueue.enqueueRetryable(async()=>{y("RemoteStore","Retrying IndexedDB access"),await n(),e.v_.delete(1),await ii(e)})}function pl(e,t){return t().catch(n=>Ar(e,n,t))}async function si(e){const t=b(e),n=Xt(t);let r=t.D_.length>0?t.D_[t.D_.length-1].batchId:-1;for(;Zm(t);)try{const i=await Lm(t.localStore,r);if(i===null){t.D_.length===0&&n.Xo();break}r=i.batchId,tg(t,i)}catch(i){await Ar(t,i)}ml(t)&&gl(t)}function Zm(e){return _e(e)&&e.D_.length<10}function tg(e,t){e.D_.push(t);const n=Xt(e);n.Jo()&&n.P_&&n.I_(t.mutations)}function ml(e){return _e(e)&&!Xt(e).Ho()&&e.D_.length>0}function gl(e){Xt(e).start()}async function eg(e){Xt(e).d_()}async function ng(e){const t=Xt(e);for(const n of e.D_)t.I_(n.mutations)}async function rg(e,t,n){const r=e.D_.shift(),i=Zs.from(r,t,n);await pl(e,()=>e.remoteSyncer.applySuccessfulWrite(i)),await si(e)}async function ig(e,t){t&&Xt(e).P_&&await async function(r,i){if(function(o){return Wp(o)&&o!==g.ABORTED}(i.code)){const s=r.D_.shift();Xt(r).Zo(),await pl(r,()=>r.remoteSyncer.rejectFailedWrite(s.batchId,i)),await si(r)}}(e,t),ml(e)&&gl(e)}async function ka(e,t){const n=b(e);n.asyncQueue.verifyOperationInProgress(),y("RemoteStore","RemoteStore received new credentials");const r=_e(n);n.v_.add(3),await Bn(n),r&&n.x_.set("Unknown"),await n.remoteSyncer.handleCredentialChange(t),n.v_.delete(3),await ii(n)}async function sg(e,t){const n=b(e);t?(n.v_.delete(2),await ii(n)):t||(n.v_.add(2),await Bn(n),n.x_.set("Unknown"))}function He(e){return e.N_||(e.N_=function(n,r,i){const s=b(n);return s.R_(),new Hm(r,s.connection,s.authCredentials,s.appCheckCredentials,s.serializer,i)}(e.datastore,e.asyncQueue,{Po:Xm.bind(null,e),To:Ym.bind(null,e),u_:Jm.bind(null,e)}),e.F_.push(async t=>{t?(e.N_.Zo(),ao(e)?oo(e):e.x_.set("Unknown")):(await e.N_.stop(),fl(e))})),e.N_}function Xt(e){return e.B_||(e.B_=function(n,r,i){const s=b(n);return s.R_(),new Km(r,s.connection,s.authCredentials,s.appCheckCredentials,s.serializer,i)}(e.datastore,e.asyncQueue,{Po:eg.bind(null,e),To:ig.bind(null,e),E_:ng.bind(null,e),T_:rg.bind(null,e)}),e.F_.push(async t=>{t?(e.B_.Zo(),await si(e)):(await e.B_.stop(),e.D_.length>0&&(y("RemoteStore",`Stopping write stream with ${e.D_.length} pending writes`),e.D_=[]))})),e.B_}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kg{constructor(t){this.observer=t,this.muted=!1}next(t){this.observer.next&&this.Ba(this.observer.next,t)}error(t){this.observer.error?this.Ba(this.observer.error,t):bt("Uncaught Error in snapshot listener:",t.toString())}La(){this.muted=!0}Ba(t,n){this.muted||setTimeout(()=>{this.muted||t(n)},0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rl(e,t,n){if(!n)throw new I(g.INVALID_ARGUMENT,`Function ${e}() cannot be called with an empty ${t}.`)}function Og(e,t,n,r){if(t===!0&&r===!0)throw new I(g.INVALID_ARGUMENT,`${e} and ${n} cannot be used together.`)}function Fa(e){if(!w.isDocumentKey(e))throw new I(g.INVALID_ARGUMENT,`Invalid document reference. Document references must have an even number of segments, but ${e} has ${e.length}.`)}function Ua(e){if(w.isDocumentKey(e))throw new I(g.INVALID_ARGUMENT,`Invalid collection reference. Collection references must have an odd number of segments, but ${e} has ${e.length}.`)}function fo(e){if(e===void 0)return"undefined";if(e===null)return"null";if(typeof e=="string")return e.length>20&&(e=`${e.substring(0,20)}...`),JSON.stringify(e);if(typeof e=="number"||typeof e=="boolean")return""+e;if(typeof e=="object"){if(e instanceof Array)return"an array";{const t=function(r){return r.constructor?r.constructor.name:null}(e);return t?`a custom ${t} object`:"an object"}}return typeof e=="function"?"a function":S()}function Ve(e,t){if("_delegate"in e&&(e=e._delegate),!(e instanceof t)){if(t.name===e.constructor.name)throw new I(g.INVALID_ARGUMENT,"Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");{const n=fo(e);throw new I(g.INVALID_ARGUMENT,`Expected type '${t.name}', but it was: ${n}`)}}return e}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ui{constructor(...t){for(let n=0;n<t.length;++n)if(t[n].length===0)throw new I(g.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new nt(t)}isEqual(t){return this._internalPath.isEqual(t._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mo{constructor(t,n){if(!isFinite(t)||t<-90||t>90)throw new I(g.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+t);if(!isFinite(n)||n<-180||n>180)throw new I(g.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+n);this._lat=t,this._long=n}get latitude(){return this._lat}get longitude(){return this._long}isEqual(t){return this._lat===t._lat&&this._long===t._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(t){return M(this._lat,t._lat)||M(this._long,t._long)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qg(e){if(e.limitType==="L"&&e.explicitOrderBy.length===0)throw new I(g.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}class Xg{convertValue(t,n="none"){switch(fe(t)){case 0:return null;case 1:return t.booleanValue;case 2:return G(t.integerValue||t.doubleValue);case 3:return this.convertTimestamp(t.timestampValue);case 4:return this.convertServerTimestamp(t,n);case 5:return t.stringValue;case 6:return this.convertBytes(de(t.bytesValue));case 7:return this.convertReference(t.referenceValue);case 8:return this.convertGeoPoint(t.geoPointValue);case 9:return this.convertArray(t.arrayValue,n);case 10:return this.convertObject(t.mapValue,n);default:throw S()}}convertObject(t,n){return this.convertObjectMap(t.fields,n)}convertObjectMap(t,n="none"){const r={};return me(t,(i,s)=>{r[i]=this.convertValue(s,n)}),r}convertGeoPoint(t){return new mo(G(t.latitude),G(t.longitude))}convertArray(t,n){return(t.values||[]).map(r=>this.convertValue(r,n))}convertServerTimestamp(t,n){switch(n){case"previous":const r=Ws(t);return r==null?null:this.convertValue(r,n);case"estimate":return this.convertTimestamp(An(t));default:return null}}convertTimestamp(t){const n=Qt(t);return new Q(n.seconds,n.nanos)}convertDocumentKey(t,n){const r=j.fromString(t);$(sl(r));const i=new Rn(r.get(1),r.get(3)),s=new w(r.popFirst(5));return i.isEqual(n)||bt(`Document ${s} contains a document reference within a different database (${i.projectId}/${i.database}) which is not supported. It will be treated as a reference in the current database (${n.projectId}/${n.database}) instead.`),s}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
sammen med bekjente før turen går til Grefsenkollen`}),m(te,{time:"16:00",what:"Aperitif på Gresenkollen restaurant",extra:"Buss 56B kl 15:45 fra Storo er perfekt!"}),m(te,{time:"17:00",what:"Middag med taler og ablegøyer"}),m(te,{time:"21:00",what:"Leker, dans, kaffe og kaker"}),m(te,{time:"00:30",what:"Nattmat"}),m(te,{time:"02:00",what:"Hjemreise"})]})]})]})}function te({time:e,what:t,extra:n}){return m(ft,{children:[m("p",{className:"time",children:e}),m("p",{className:"what",children:t}),n&&m("p",{className:"extra",children:n})]})}function g_(){return m(ft,{children:[m(Dr,{includeBack:!0}),m("div",{className:"center-container",children:[m("h1",{children:"Praktisk info"}),m("h2",{children:"Toastmaster"}),m("p",{children:m("s",{children:["Adrian Austevoll er vår eminente toastmaster. Ta kontakt med ham på telefon ",m("a",{href:"tel:94974009",children:"949 74 009"})," dersom du har lyst til å si noen ord."]})}),m("p",{children:["Anders Bentsen tar over som toastmaster da Adrian dessverre har blitt syk. Anders er en ringrev med lokalkunnskap om Grefsen og diverse løkkaleker, så dette blir bra. Han kan nåes på telefon"," ",m("a",{href:"tel:99468197",children:"994 68 197"}),"."]}),m("h2",{children:"Transport og parkering"}),m("h3",{children:"Vielse i Oslo Rådhus"}),m("p",{children:["Trikk, tog, t-bane eller buss til Nationaltheatret. Dersom du kjører bil, finner du en"," ",m("a",{href:"https://no.parkopedia.com/parking/carpark/vika_p_hus/0250/oslo/?arriving=202402041600&leaving=202402041800",children:"oversikt over parkeringshus i Oslo her."})," "]}),m("p",{children:"Det er generelt få offentlige parkeringsplasser i rundt Rådhuset. Vika P-hus eller Oslo Konserthus P-hus er nærmest."}),m("p",{children:"Det er ikke tillatt med ballonger, såplebobler, alkohol eller å kaste ris, roseblader eller konfetti. Dette gjelder både inne og utenfor rådhuset."}),m("h3",{children:"Grefsenkollen Resturant"}),m("p",{children:["Buss ",m("i",{children:"56B Grefsenkollen"})," tar deg fra Nydalen eller Storo hele veien opp til Grefsenkollen Resturant. Bussen som går kl 15:45 fra Storo ankommer Grefsenkollen i perfekt tid!"]}),m("p",{children:"Dersom du kjører bil er det mange kommunale parkeringsplasser tilgjengelig rett utenfor restauranten. Det er gratis å stå parkert her. Det er også en stor parkeringsplass 200 meter ned i bakken. Her er det også gratis å stå."}),m("h2",{children:"Hva i all verden betyr kleskoden Mørk dress eller bunad?"}),m("p",{children:"Mørk dress for menn er en formell kleskode som gjerne innebærer en mørkeblå, sort eller mørkegrå dressjakke og bukse, kombinert med en hvit eller lys skjorte og et slips eller en sløyfe. For kvinner innebærer mørk dress ofte en formell kjole eller drakt, gjerne i knelengde eller lengre. Bunad er også veldig lov. Men, husk at det viktigste er at DU føler deg fin!"}),m("h2",{children:"Leker"}),m("p",{children:"Vil du gjennomføre en lek istedenfor tale? Gøy! Kontakt toastmaster Adrian."}),m("h2",{children:"Allergier"}),m("p",{children:"Dersom du er allergisk eller er pesceterianer, vegetarianer, veganer eller lignende er det viktig at du gir oss beskjed på forhånd så vi kan melde fra videre til Grefsenkollen."})]})]})}function Vr(){return Vr=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},Vr.apply(this,arguments)}var we;(function(e){e.Pop="POP",e.Push="PUSH",e.Replace="REPLACE"})(we||(we={}));var za=function(e){return e},Ha="beforeunload",__="hashchange",y_="popstate";function v_(e){e===void 0&&(e={});var t=e,n=t.window,r=n===void 0?document.defaultView:n,i=r.history;function s(){var V=Wa(r.location.hash.substr(1)),R=V.pathname,U=R===void 0?"/":R,gt=V.search,xt=gt===void 0?"":gt,Ot=V.hash,Ge=Ot===void 0?"":Ot,jt=i.state||{};return[jt.idx,za({pathname:U,search:xt,hash:Ge,state:jt.usr||null,key:jt.key||"default"})]}var o=null;function a(){if(o)d.call(o),o=null;else{var V=we.Pop,R=s(),U=R[0],gt=R[1];if(d.length){if(U!=null){var xt=h-U;xt&&(o={action:V,location:gt,retry:function(){dt(xt*-1)}},dt(xt))}}else F(V)}}r.addEventListener(y_,a),r.addEventListener(__,function(){var V=s(),R=V[1];Di(R)!==Di(l)&&a()});var u=we.Pop,c=s(),h=c[0],l=c[1],f=Ga(),d=Ga();h==null&&(h=0,i.replaceState(Vr({},i.state,{idx:h}),""));function E(){var V=document.querySelector("base"),R="";if(V&&V.getAttribute("href")){var U=r.location.href,gt=U.indexOf("#");R=gt===-1?U:U.slice(0,gt)}return R}function T(V){return E()+"#"+(typeof V=="string"?V:Di(V))}function _(V,R){return R===void 0&&(R=null),za(Vr({pathname:l.pathname,hash:"",search:""},typeof V=="string"?Wa(V):V,{state:R,key:E_()}))}function A(V,R){return[{usr:V.state,key:V.key,idx:R},T(V)]}function D(V,R,U){return!d.length||(d.call({action:V,location:R,retry:U}),!1)}function F(V){u=V;var R=s();h=R[0],l=R[1],f.call({action:u,location:l})}function Z(V,R){var U=we.Push,gt=_(V,R);function xt(){Z(V,R)}if(D(U,gt,xt)){var Ot=A(gt,h+1),Ge=Ot[0],jt=Ot[1];try{i.pushState(Ge,"",jt)}catch{r.location.assign(jt)}F(U)}}function mt(V,R){var U=we.Replace,gt=_(V,R);function xt(){mt(V,R)}if(D(U,gt,xt)){var Ot=A(gt,h),Ge=Ot[0],jt=Ot[1];i.replaceState(Ge,"",jt),F(U)}}function dt(V){i.go(V)}var wt={get action(){return u},get location(){return l},createHref:T,push:Z,replace:mt,go:dt,back:function(){dt(-1)},forward:function(){dt(1)},listen:function(R){return f.push(R)},block:function(R){var U=d.push(R);return d.length===1&&r.addEventListener(Ha,Ka),function(){U(),d.length||r.removeEventListener(Ha,Ka)}}};return wt}function Ka(e){e.preventDefault(),e.returnValue=""}function Ga(){var e=[];return{get length(){return e.length},push:function(n){return e.push(n),function(){e=e.filter(function(r){return r!==n})}},call:function(n){e.forEach(function(r){return r&&r(n)})}}}function E_(){return Math.random().toString(36).substr(2,8)}function Di(e){var t=e.pathname,n=t===void 0?"/":t,r=e.search,i=r===void 0?"":r,s=e.hash,o=s===void 0?"":s;return i&&i!=="?"&&(n+=i.charAt(0)==="?"?i:"?"+i),o&&o!=="#"&&(n+=o.charAt(0)==="#"?o:"#"+o),n}function Wa(e){var t={};if(e){var n=e.indexOf("#");n>=0&&(t.hash=e.substr(n),e=e.substr(0,n));var r=e.indexOf("?");r>=0&&(t.search=e.substr(r),e=e.substr(0,r)),e&&(t.pathname=e)}return t}function T_(){return m(ft,{children:m(lu,{history:v_(),children:[m(Kn,{path:"/",component:mh}),m(Kn,{path:"/program",component:m_}),m(Kn,{path:"/info",component:g_}),m(Kn,{path:"/onskeliste",component:d_})]})})}Yl(m(T_,{}),document.getElementById("app"));
